...
public class VentanaTen extends javax.swing.JFrame {
   ...
   private Clip clip;
    ...
    public VentanaTen() {
        ...
        portada = new ImageIcon(getClass().getResource("/imagenes/ten.png")); 
        contraportada = new ImageIcon(getClass().getResource("/imagenes/tenCon.png")); 
        
        lblKirby.setIcon(null); // no mostrar gif al inicio
        lblKirby1.setIcon(portada); // mostrar primero la portada
        btnBoton.addMouseListener(new VentanaTen.interna()); 
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Ten");
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 0, 140, 30));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaTen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaTen().setVisible(true);
            }
        });
    }
